...
Tags: administration, putler, jigoshop, ecommerce, management, reporting, analysis, sales, products, orders, history, customers, graphs, charts
...
Track Jigoshop orders on desktop and mobile with [Putler](http://putler.com/) -  Insightful reporting that grows your business.

Jigoshop Putler Connector sends transactions to Putler using Putler's Inbound API. All past orders are sent when you first configure this plugin. Future orders will be sent to Putler automatically. 

You need a Putler account (Free or Paid), and a Jigoshop based store to use this plugin.

= Installation =

1. Ensure you have latest version of [Jigoshop](http://jigoshop.com/) plugin installed
2. Unzip and upload contents of the plugin to your `/wp-content/plugins/` directory
3. Activate the plugin through the 'Plugins' menu in WordPress
4. Click on 'Jigoshop Putler Connector ' option within WordPress admin sidebar menu

= Configuration =

Go to Wordpress > Tools > Putler Connector

This is where you need to enter Putler API Token and Putler Email Address to sync your past Jigoshop transactions to Putler and start tracking Jigoshop transactions with Putler.
...
3. Click on "Save & Send Past Orders to Putler" to send all the Jigoshop past orders to Putler.
...
1. Jigoshop Putler Connector Settings Page
